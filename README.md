...
Чтобы использовать докер достаточко клонировать себе репозиторий и из папки репозитория выполнить команду:
...
Оба скрипта требуют файлы с URL'ами в формате массива где каждый элемент подходит пот требования запроса.